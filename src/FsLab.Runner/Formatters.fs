...
with
    ...
    member __.With(f:FormatConfig -> FormatConfig) = f __

    // Tuples with the counts, for easy use later on
    member internal __.fcols = __.StartColumnCount,          __.EndColumnCount
    member internal __.frows = __.StartRowCount,             __.EndRowCount
    member internal __.sitms = __.StartItemCount,            __.EndItemCount
    member internal __.mcols = __.MatrixStartColumnCount,    __.MatrixEndColumnCount
    member internal __.mrows = __.MatrixStartRowCount,       __.MatrixEndRowCount
    member internal __.vitms = __.VectorStartItemCount,      __.VectorEndItemCount
