...
module XPlotHtmlPrinters = 
  ...
  // --------------------------------------------------------------------------------------
  // HTML formatting for Google charts, for hosts that use HAS_FSI_ADDHTMLPRINTER
  // --------------------------------------------------------------------------------------

  // Hacky reflection-based mutator that sets chart styles to the default theme
  let rec private getValue (p:Expr) =
    match p with
  ...
  let private applyTheme (ch:XPlot.GoogleCharts.GoogleChart) =
  ...
  // --------------------------------------------------------------------------------------
  // HTML formatting for Plotly charts, for hosts that use HAS_FSI_ADDHTMLPRINTER
  // --------------------------------------------------------------------------------------
  ...
  let private plotlyLoadScript = """<script type="text/javascript">
    $(function() { 
